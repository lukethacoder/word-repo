...
excerpt: A quick look into how to build LWCs with slots to allow for nesting of LWCs
...
W> Before continuing, Aura based Communities are (sadly) not supported. So if you're currently using them it might be time to make the switch to LWR.
...
![Experience Builder: Draging our custom LWC onto the page](/lwc-nested-components/nested-lwc-1.gif)
...
![Experience Builder: Draging our custom LWC onto the page](/lwc-nested-components/nested-lwc-2.gif)
